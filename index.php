<?php
$testo = 'The European languages are members of the same family. Their separate existence
    ...
    simple and regular than that of the individual languages. The new common language will be more simple and
    regular than the existing European languages. It will be as simple as Occidental; in fact, it will be Occidental.
